...
// Tambahkan ikon 'Info' dari lucide-react di baris ini 👇
import { ShoppingCart, Star, Plus, Check, Search, Filter, Tag, Info } from "lucide-react";
  ...
  return (
    <div style={{ backgroundColor: "#F8F3E1" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 p-4 rounded-xl flex items-start gap-3 border shadow-sm" style={{ backgroundColor: "#FFFBEB", borderColor: "#FDE68A" }}>
          <Info className="shrink-0 mt-0.5" size={20} style={{ color: "#F59E0B" }} />
          <div>
            <h4 className="font-bold text-sm mb-1" style={{ color: "#92400E" }}>Sedang Dalam Penyempurnaan 🛠️</h4>
            <p className="text-xs font-medium leading-relaxed" style={{ color: "#B45309" }}>
              Sistem *checkout* otomatis dengan perhitungan ongkos kirim akan segera dirilis! Untuk sementara, silakan pilih menu yang Anda inginkan, masukkan ke keranjang, dan tekan tombol <b>"Pesan via WhatsApp"</b> untuk melakukan transaksi secara manual. Terima kasih atas pengertiannya!
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <div className="relative">
            ...
            <select
              title="Urutkan pesanan"
              aria-label="Urutkan pesanan"
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="pl-9 pr-4 py-3 rounded-xl text-sm font-medium focus:outline-none appearance-none cursor-pointer border bg-white border-[#D5CEAB] text-[#41431B]"
            >
